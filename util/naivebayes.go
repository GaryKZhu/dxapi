...
func main() {
   ...
   var ss []kv
	...
	best, scores, names := GetMostLikeDisease(tv, unconvert, convert)
...
func GetMostLikeDisease(query []float64, unconvert map[int]string, convert map[string]int) (m string, probs []float64, diseases []string) {
